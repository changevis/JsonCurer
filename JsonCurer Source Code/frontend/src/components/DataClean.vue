...
export default defineComponent({
  ...
  setup(_, { emit }) {
    ...
    watch(() => store.getters.getCurrentForm, () => {
    ...
    async function confirmTransformation() {
      ...
      store.commit('addLog', generateLogInfo(store.getters.getCurrentIssue, generateDescription(store.getters.getCurrentIssueDesc, store.getters.getCurrentIssue), store.state.transformationDesc));
