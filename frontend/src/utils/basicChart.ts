...
export const generateBarOption = (
  ...
  const option = {
    ...
    tooltip: mode === 'schema' ? {
      ...
      extraCssText: 'font-size: 10px; height: 15px; padding: 0; padding-top: 6px; background: #4b4d53; border: none; border-radius: 0; color: #cfd1d4',
      textStyle: {
        fontSize: 1,
      },
    } : {
...
export const generateFreqHistoOption = (
  ...
  const option = {
    ...
    tooltip: mode === 'schema' ? {
      ...
      extraCssText: 'font-size: 10px; padding: 0; padding-top: 6px; background: #4b4d53; border: none; border-radius: 0; color: #cfd1d4; overflow: hidden',
      textStyle: {
        fontSize: 1,
      },
    } : {
...
export const dataPrepForComplex = (info: any) => {
  const xTitle = [typeShortMapFull.a, 'a'].includes(info.dataType) ? 'EleNum' : 'KeyNum';
