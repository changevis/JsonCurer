<template>
  ...
  <el-row v-show="formData.targetType === 'a'">
    <el-col :span="6">
      <span class="label-style">String Split By</span>
    </el-col>
    <el-col :span="16">
      <el-input v-model="formData.splitBy" placeholder="e.g. -,." />
    </el-col>
  </el-row>
  <el-row v-show="formData.targetType === 's'">
    <el-col :span="6">
      <span class="label-style">Array Join By</span>
    </el-col>
    <el-col :span="16">
